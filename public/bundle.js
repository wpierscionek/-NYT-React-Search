				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								"button",
								{ type: "button", className: "btn waves-effect waves-light", onClick: this.handleClick },
								"Submit"
							)
						)
					)
		...
		render: function render() {
			if (!this.props.list) {
				return React.createElement(
					"p",
					null,
					"Enter a movie to start the search"
				);
			} else {
				console.log("working?");
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									"div",
									{ className: "col s4" },
									React.createElement("img", { src: movies.Poster, alt: movies.Title, width: "100%" })
								)
							)
						)
					)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
		...
		runQuery: function runQuery(movies) {
